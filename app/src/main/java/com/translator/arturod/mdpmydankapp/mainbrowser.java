 ...
 */
public class
        mainbrowser extends android.app.Fragment implements View.OnClickListener {
    View myView;
    WebView webview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        webview.loadUrl("https://www.youtube.com/watch?v=JibvqnG5VZc");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.front:
                ...
                Toast toast1= Toast.makeText(getActivity().getApplicationContext(), "opening reddit dank memes", Toast.LENGTH_SHORT);
                toast1.setGravity(Gravity.CLIP_VERTICAL  | Gravity.CENTER_HORIZONTAL, 0, 0);
                toast1.show();
                break;
            case R.id.back :
                mainbrowser2back   fragment1 = new mainbrowser2back() ;
                FragmentTransaction fragmentTransaction1  = getFragmentManager().beginTransaction();
                fragmentTransaction1.replace(R.id.fragment_container, fragment1);
                fragmentTransaction1.commit();

                Toast toast2= Toast.makeText(getActivity().getApplicationContext(), "opening imgur dank memes", Toast.LENGTH_SHORT);
