 ...
 */
public class
        meme extends android.app.Fragment implements View.OnClickListener{
    View myView;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.fragment_meme    , container, false);
    ...
    public void onClick(View v) {
        String cP = getString(R.string.memes   );
        switch (v.getId()) {
            case R.id.copyf :
            ...
            case R.id.sharef:
                ...
                Toast toast1= Toast.makeText(getActivity().getApplicationContext(), "share opening", Toast.LENGTH_SHORT);
