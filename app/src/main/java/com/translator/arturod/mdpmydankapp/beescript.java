 ...
 */
public class
        beescript extends android.app.Fragment implements View.OnClickListener{
    View myView;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.fragment_beescript     , container, false);
    ...
    public void onClick(View v) {
        String cP = getString(R.string.beems  );
        switch (v.getId()) {
            case R.id.copyf :
