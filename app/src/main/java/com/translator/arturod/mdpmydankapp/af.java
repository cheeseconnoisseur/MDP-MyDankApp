 ...
 */
public class
        af extends android.app.Fragment implements View.OnClickListener{
    View myView;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.fragment_af    , container, false);
    ...
    public void onClick(View v) {
        String cP = getString(R.string.cailloou    );
        switch (v.getId()) {
            case R.id.copyf :
