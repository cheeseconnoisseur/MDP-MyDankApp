 ...
 */
public class
        trumpspeech extends android.app.Fragment implements View.OnClickListener{
    View myView;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.fragment_trumpspeech  , container, false);
    ...
    public void onClick(View v) {
        String cP = getString(R.string.trumpspeech  );
        switch (v.getId()) {
            case R.id.copyf :
