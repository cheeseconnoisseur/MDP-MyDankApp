 ...
 */
public class
        confused extends android.app.Fragment implements View.OnClickListener{
    View myView;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.fragment_confused      , container, false);
    ...
    public void onClick(View v) {
        String cP = getString(R.string.confu  );
        switch (v.getId()) {
            case R.id.copyf :
